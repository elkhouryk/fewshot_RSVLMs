...
NEW_CLASSNAMES = {
    ...
    "artificialgrassland": "artificial grassland",
    "avenue": "avenue",
    "bareland": "bare land",
    "bridge": "bridge",
    "cityavenue": "city avenue",
    "citybuilding": "city building",
    "citygreentree": "city green tree",
    "cityroad": "city road",
    "coastline": "coastline",
    "container": "container",
    ...
    "naturalgrassland": "natural grassland",
    "overpass": "overpass",
    ...
    "residents": "residents",
    "river": "river",
    "riverprotectionforest": "river protection forest",
    "sandbeach": "sandbeach",
    "sapling": "sapling",
    "sea": "sea or lake",
    "shrubwood": "shrubwood",
...
class rsicb128(DatasetBase):

    dataset_dir = "rsicb128"
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.split_path):
            ...
            train, val, test = self.read_and_split_data(self.image_dir, NEW_CLASSNAMES=NEW_CLASSNAMES)
    ...
    @staticmethod
    def read_and_split_data(image_dir, p_trn=0.5, p_val=0.2, ignored=[], NEW_CLASSNAMES=None):
        ...
        for label, category in enumerate(categories):
            ...
            if NEW_CLASSNAMES is not None and category in NEW_CLASSNAMES:
                category = NEW_CLASSNAMES[category]
